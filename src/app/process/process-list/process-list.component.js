...
var ProcessListComponent = (function () {
    ...
    ProcessListComponent.prototype.filter = function () {
        ...
        if (this.processFilterForm.processInstanceId) {
            ...
            var processFilter = new process_filter_1.ProcessFilter(this.processFilterForm.processDefinitionElement ?
                this.processFilterForm.processDefinitionElement.key : undefined, this.processFilterForm.processDefinition.id, this.processFilterForm.variablesToFilter);
    ...
    ProcessListComponent.prototype.addVariable = function () {
        this.processFilterForm.variablesToFilter.set('', '');
    };
    ProcessListComponent.prototype.removeVariable = function (key) {
        this.processFilterForm.variablesToFilter.delete(key);
    };
